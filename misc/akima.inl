/*! @file akima.inl
   ...
   AKIMA INTERPORATION on MISC LIBRARY.
...
// akima --------------------------
template< class D >
void akima<D>::add( const D& x, const D& y )
{
	m_data.push_back(
		akima_element(x,y)
	);
